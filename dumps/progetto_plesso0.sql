...
CREATE TABLE `plesso` (
  ...
  `nPiani` int DEFAULT '1',
  `Ascensore` tinyint DEFAULT '0',
  PRIMARY KEY (`id`)
...
INSERT INTO `plesso` VALUES ('p1','Via E.Murmura',3,1),('p2','Via D.Alighieri',2,NULL);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `asce` BEFORE INSERT ON `plesso` FOR EACH ROW BEGIN
    IF new.nPiani>2
		 THEN
			SET new.Ascensore = true;
	end if;
END */;;
DELIMITER ;
