...
CREATE TABLE `insegna` (
  ...
  `IDInsegnante` varchar(255) NOT NULL,
  `ore` int DEFAULT NULL,
  PRIMARY KEY (`IDClasse`,`AnnoScolastico`,`IDInsegnante`),
  KEY `IDInsegnante` (`IDInsegnante`),
  CONSTRAINT `insegna_ibfk_1` FOREIGN KEY (`IDInsegnante`) REFERENCES `insegnante` (`CF`),
  CONSTRAINT `insegna_ibfk_2` FOREIGN KEY (`IDClasse`) REFERENCES `classe` (`IDClasse`)
