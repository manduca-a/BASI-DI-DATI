...
--
-- Table structure for table `fasce_eta`
--

DROP TABLE IF EXISTS `fasce_eta`;
...
--
-- Dumping data for table `fasce_eta`
--

LOCK TABLES `fasce_eta` WRITE;
/*!40000 ALTER TABLE `fasce_eta` DISABLE KEYS */;
INSERT INTO `fasce_eta` VALUES ('Adolescente',10,15),('Bambino',3,5),('Fanciullo',5,10),('Infante',2,3);
